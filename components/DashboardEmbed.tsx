...
const DashboardEmbed: React.FC<DashboardEmbedProps> = ({ url, title }) => {
  ...
  return (
    <div className="w-full aspect-[4/3] bg-[#0a0a0a] border border-white/10 rounded-lg relative overflow-hidden group max-w-5xl mx-auto">
      ...
      {url ? (
        ...
        <div className="absolute inset-0 flex items-center justify-center pt-8 bg-[#050505]">
